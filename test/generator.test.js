...
const fixtures = [
  ...
  },
  {
    ...
    expected: dedent`
      ...
      let s_3 = {side1: 5, side2: 9, side3: 2, area: function() {return "sorry no functionality for area of triangle yet"}, perimeter: function() {return 5 + 9 + 2}, type: function() {return Scalene}};
